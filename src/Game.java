...
//					add(cup1);
					...
					add(oreo1);
					setComponentZOrder(oreo1,2);
					
					oreo12.setBounds(560,190,400,360);
					add(oreo12);
					setComponentZOrder(oreo12,2);
					c=1;
