...
//				   int y = e.getY();
		...
		ImageIcon ingreFruits2 = new ImageIcon("ingreFruit2.png");
...
//					add(cup1);
		...
		ImageIcon ingreFruits3 = new ImageIcon("ingreFruit3.png");
...
//					add(cup1);
		...
		ImageIcon ingreFruits4 = new ImageIcon("ingreFruit4.png");
...
//					add(cup1);
		...
		ImageIcon ingreJuices4 = new ImageIcon("ingreJuice4.png");
...
//					add(cup1);
	...
	public void chk() {
		...
		if(menu[0].equals("녹차쉐이크")) {
			...
			if(d==1&&b1==1&&chk>=65&&chk<=75&&chkresult==3&&b2==1) {
		...
		if(menu[0].equals("블루베리에이드")) {
			...
			if(b==1&&c1==1&&chk>=25&&chk<=35&&chkresult==2&&c2==1) {
		...
		if(menu[0].equals("딸기요거트")) {
			...
			if(a==1&&a1==1&&chk>=25&&chk<=35&&chkresult==2&&a2==1) {
